...
class C5PB_BASE {
	...
	function decode($value) {
		...
		}elseif( is_array(@code125_decode($value) ) ){
			return code125_decode($value);
		}else {
			return $value;
		}
	}
	...
	function html() {
		...
		<div class="c5ab-base-elements c5ab-<?php echo $this->type; ?>-base-elements clearfix <?php echo $this->sub_classes(); ?>">
		<?php
	...
	function display_setting( $args = array(), $instance= array() ) {
	      ...
	      if( ( $type == 'list-item' || $type == 'custom-background' ||  $type == 'background' || $type == 'spacing' || $type == 'spacing-type' || $type == 'border' || $type == 'box-shadow') && $field_value!=''){
	      	unset($field_value);
	      	$field_value= array();
		  ...
		  echo '<div class="format-settings format-settings-'.$id_tag.' '.$class.'">';
