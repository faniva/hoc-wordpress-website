...
function getPostLikeLink($post_id)
{
	...
	if(hasAlreadyVoted($post_id))
		$output .= ' <span title="'.__('like', 'medical-cure').'" class="qtip like alreadyvoted fa fa-heart"></span><span class="count">'.$vote_count.'</span>';
	else
		$output .= '<a href="#" data-post_id="'.$post_id.'">
					<span  title="'.__('like', 'medical-cure').'" class="qtip like  fa fa-heart"></span><span class="count">'.$vote_count.'</span></a>';
	$output .= '</p>';
	}else {
		$output ='';
	}
