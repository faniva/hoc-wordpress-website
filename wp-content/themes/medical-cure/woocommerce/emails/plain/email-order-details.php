...
echo strtoupper( sprintf( __( 'Order number: %s', 'medical-cure' ), $order->get_order_number() ) ) . "\n";
...
if ( $sent_to_admin ) {
	echo "\n" . sprintf( __( 'View order: %s', 'medical-cure' ), admin_url( 'post.php?post=' . $order->get_id() . '&action=edit' ) ) . "\n";
}
