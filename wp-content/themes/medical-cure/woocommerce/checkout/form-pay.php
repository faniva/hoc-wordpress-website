	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'medical-cure' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'medical-cure' ); ?></th>
			</tr>
		</thead>
		<tbody>
