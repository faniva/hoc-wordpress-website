...
class C5AB_ads extends C5_Widget {
	...
	function shortcode($atts,$content) {
		...
		if( ( $atts['mobile'] == 'off') && c5_is_mobile()){
			return;
		}

		if( ( $atts['tablet'] == 'off') && c5_is_tablet()){
			return;
		}

		if( ( $atts['desktop'] == 'off') && c5_is_desktop()){
			return;
		}

		$content = str_replace('CODE125_THEMEURL', C5_URI . 'library/images/ads' , $content );
