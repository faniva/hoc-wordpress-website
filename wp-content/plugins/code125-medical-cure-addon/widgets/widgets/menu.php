...
class C5AB_menu extends C5_Widget {
    ...
    function shortcode($atts, $content) {
        ...
        if (has_nav_menu($atts['location'])) {
            ...
            return '<nav class="navigation-shortcode responsive-' . $atts['responsive'] . ' ' . $atts['bg_mode'] . ' ' . $atts['style'] . ' top-menu-nav clearfix">' . $menu . '</nav>';
        } else {
            ...
            if ($atts['location'] == 'main-nav') {
                $args = array(
                    ...
                    'link_before' => '',
                    'link_after' => '');
                return '<nav class="c5-pages-menu-wrap navigation-shortcode ' . $atts['responsive'] . ' ' . $atts['bg_mode'] . ' ' . $atts['style'] . ' top-menu-nav clearfix" style="display:none;"><div class="responsive-controller clearfix"><span class="menu-enable icon-menu"></span></div>' . wp_page_menu($args) . '</nav>';
            }
            return '';
        }
    }
